...
//   const mobileLinks = filteredLinks;
//   // .reduce((acc, link) => {
...
//   return (
//     <header className="sticky top-0 z-10 flex h-14 items-center gap-4 border-b bg-black/60 px-4 lg:h-[60px] lg:px-6">
//       <Sheet>
...
export default function Navbar({ session }: { session: Session }) {
  ...
  // Temporarily remove permission checking for simplicity
  // In a real app, you would implement the usePermission hook
  const filteredLinks = sidebarLinks;
