...
//       { month: "Jun", efficiency: 83 },
//     ],
//     memberContributions: [
//       { name: "Alex", tasks: 18 },
//       { name: "Taylor", tasks: 15 },
//       { name: "Jordan", tasks: 14 },
//       { name: "Casey", tasks: 12 },
//       { name: "Morgan", tasks: 10 },
//       { name: "Riley", tasks: 8 },
//     ],
//   },
//   {
...
//     memberContributions: [
//       { name: "Blake", tasks: 16 },
//       { name: "Cameron", tasks: 14 },
//       { name: "Hayden", tasks: 13 },
//       { name: "Parker", tasks: 11 },
//     ],
//   },
//   {
//     id: 4,
...
//       { month: "Feb", efficiency: 80 },
//       { month: "Mar", efficiency: 81 },
//       { month: "Apr", efficiency: 82 },
//       { month: "May", efficiency: 82 },
//       { month: "Jun", efficiency: 83 },
//     ],
//     memberContributions: [
//       { name: "Jordan", tasks: 17 },
//       { name: "Taylor", tasks: 15 },
//       { name: "Casey", tasks: 13 },
//       { name: "Morgan", tasks: 11 },
//       { name: "Riley", tasks: 9 },
//     ],
//   },
//   {
...
// const teamPerformanceData = teamsData[0].performance.map((month) => {
//   const data: { month: string; [key: string]: string | number } = {
//     month: month.month,
//   };
//   teamsData.forEach((team) => {
//     const teamMonth = team.performance.find((m) => m.month === month.month);
...
//   teamData: Team[];
// }) {
//   const [selectedTeam, setSelectedTeam] = useState(teamsData[0].id.toString());
//   const [departmentFilter, setDepartmentFilter] = useState("all");

//   const filteredTeams =
//     departmentFilter === "all"
//       ? teamsData
//       : teamsData.filter((team) => team.department === departmentFilter);
...
//               Total Teams
//             </CardDescription>
//             <CardTitle className="text-2xl">{filteredTeams.length}</CardTitle>
//           </CardHeader>
//           <CardContent>
...
//           <CardDescription className="text-gray-400">
//             Detailed metrics for all teams
//           </CardDescription>
//         </CardHeader>
//         <CardContent>
//           <Table>
