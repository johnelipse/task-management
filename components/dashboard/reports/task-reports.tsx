...
//   notStarted: tasksData.filter((task) => task.status === "Not Started").length,
//   overdue: tasksData.filter((task) => task.status === "Overdue").length,
// };
...
//   { date: "Jun 10", completed: 1, inProgress: 5, notStarted: 4 },
//   { date: "Jun 12", completed: 2, inProgress: 5, notStarted: 3 },
//   { date: "Jun 14", completed: 2, inProgress: 6, notStarted: 2 },
//   { date: "Jun 16", completed: 3, inProgress: 5, notStarted: 2 },
//   { date: "Jun 18", completed: 3, inProgress: 6, notStarted: 1 },
//   { date: "Jun 20", completed: 3, inProgress: 5, notStarted: 2 },
// ];
...
//               Total Tasks
//             </CardDescription>
//             <CardTitle className="text-2xl">{tasksData.length}</CardTitle>
//           </CardHeader>
//           <CardContent>
...
//               <span>
//                 {Math.round((statusCounts.completed / tasksData.length) * 100)}%
//                 of total
//               </span>
//             </div>
//           </CardContent>
...
//             <CardTitle className="text-2xl">{statusCounts.overdue}</CardTitle>
//           </CardHeader>
//           <CardContent>
