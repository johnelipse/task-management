...
import type { Task, StatusTypes, Board } from "@prisma/client";
...
export default function TeamBoard({
  ...
  useEffect(() => {
    if (board && allTasks) {
      ...
      const teamTasks = allTasks.filter((task) => task.boardId === board.id);
  ...
  return (
    <div className="min-h-screen bg-black">
      <header className="flex items-center justify-between p-4 bg-gradient-to-r from-purple-900 via-violet-950 to-indigo-950 rounded-lg m-4 shadow-lg">
